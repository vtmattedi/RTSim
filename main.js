...
const config = sim.systemConfig.map((item => {
    return { name: item.name, value: item.value};
}));
// console.log(fs.existsSync('./systemconfig.json'));
// if (fs.existsSync('./systemconfig.json'))
// {
//     console.log("File exists, deleting it...");
//     fs.unlinkSync('./systemconfig.json', (err) => {
//         if (err) {
...
fs.writeFileSync('./systemconfig.json', JSON.stringify(t, null, 2), 'utf8');
