...
import { arrowUp, arrowDown, arrowLeft, arrowRight, arrowUpDown } from './Arrows.js';
...
const genProcessorsFrame = (history, currentIndex) => {
    ...
    const table = genTaskTable(history[currentIndex].currentTasks, table_slots, history[currentIndex].currentTasks.length);
...
export { genTaskTable, genProcessorGraph, genProcessorsFrame };